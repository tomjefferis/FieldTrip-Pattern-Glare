...
model = EEGNet_seq(2, 128, 2150, loss='sparse_categorical_crossentropy', dropoutType='SpatialDropout2D', learning_rate=0.001)
history = model.fit(X_train, Y_train, epochs=500, validation_data=(X_test, Y_test))
#save model
model.save("eegnet_binary.h5")
