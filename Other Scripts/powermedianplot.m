...
statistic = 'freq'; % "freq" (default) or defined statistic from fieldtrip
...
itc = 'pow'; %pow or itc depending on wether you want to do itc or power analysis, note if using itc statistic has to be set to: ft_statfun_diff_itc
%% plotting function
clust_volume = false;
