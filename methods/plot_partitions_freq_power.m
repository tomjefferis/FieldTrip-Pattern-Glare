...
[highl, lowl] = ylimit_finder(high1,electrode);
    ...
    Ax = subplot(4, 2, 1);
    plot(low.time,lowitpc1,'g',low.time,lowitpc2,'b',low.time,lowitpc3,'r','LineWidth', 1.4);
    xlim(xlimit);
    ylim(ylimit_line);
    title(title1);
    ...
    Ax = subplot(4, 2, 2);
    plot(high.time,highitpc1,'g',high.time,highitpc2,'b',high.time,highitpc3,'r','LineWidth', 1.4);
    xlim(xlimit);
    ylim(ylimit_line);
    title(title1);
    xline(3, '--o', {"Stimulus", "Off"});
